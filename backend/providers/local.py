...
class LocalProvider(BaseAIProvider):
    ...
    def _ensure_model_exists(self, client: ollama.Client):
    ...
    def verify_protocol(self, transcription: str, protocol: str) -> Dict[str, Any]:
        ...
        res = self._call_ollama(messages, temperature=0.1)
        return {
