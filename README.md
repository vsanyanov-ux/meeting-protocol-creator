...
**Версия 4.2.1 (Stability & Performance Patch)**
...
## ✨ Ключевые особенности v4.2.1
- **🎙️ Hybrid Diarization (NEW):** Двухэтапное распознавание спикеров. Pyannote (аудио) находит смену голосов, а Ollama (семантика) дает им реальные имена на основе контекста беседы.
- **🛡️ Resilience (Отказоустойчивость):** Внедрена система **Atomic Persistence** на базе SQLite. Если обработка прервется, система возобновит работу с последнего сохраненного чанка.
...
- **🛡️ AI-Аудитор 2.0:** Автоматический контроль качества с выносом отчета аудитора в финал протокола.
