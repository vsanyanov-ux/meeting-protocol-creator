...
**Версия 5.4.0 (Meeting Context & Accuracy Update)**
...
## ✨ Ключевые особенности v5.4.0 (Meeting Intelligence)
- **🧠 Контекстное управление:** Поля ввода участников и тем встречи для повышения точности транскрибации и исключения галлюцинаций.
