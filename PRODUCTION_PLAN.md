...
| 2 | ⬇️ Endpoint скачивания DOCX | ~45 мин | ⬜ TODO |
| 3 | 🎞️ Мультиформатность (normalizer) | ~2-3 ч | ⬜ TODO |
| 4 | 🏗️ Provider Pattern рефакторинг | ~3-4 ч | ⬜ TODO |
| 5 | ⏱️ Надёжность (таймауты + очистка) | ~1-2 ч | ⬜ TODO |
| 6 | 📋 Логирование | ~1 ч | ⬜ TODO |
| 7 | 🚦 Очередь и лимиты | ~2 ч | ⬜ TODO |
| 8 | 🧪 Тесты | ~4-6 ч | ⬜ TODO |
| 9 | 🐳 Docker | ~2 ч | ⬜ TODO |
